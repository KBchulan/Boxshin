...
public:
    ...
    void scene_enter() {
        ...
        confirm_button.top = 400;
        confirm_button.left = confirm_button.right - confirm_button_x;
        confirm_button.bottom = confirm_button.top + confirm_button_y;
        confirm = Confirm(confirm_button, _T("resource/confirm_idle.png"), _T("resource/confirm_hovered.png"), _T("resource/confirm_pushed.png"), confirm_button_x, confirm_button_y);
   
        concel_button.left = 720;
        concel_button.top = 400;
        concel_button.right = concel_button.left + concel_button_x;
        concel_button.bottom = concel_button.top + concel_button_y;
        concel = Concel(concel_button, _T("resource/concel_idle.png"), _T("resource/concel_hovered.png"), _T("resource/concel_pushed.png"), concel_button_x, concel_button_y);
...
private:
    RECT confirm_button;
    int confirm_button_x = 200,
        confirm_button_y = 130;
    Confirm confirm;

    RECT concel_button;
    int concel_button_x = 200,
        concel_button_y = 130;
    Concel concel;
